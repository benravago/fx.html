...
*/
@Disabled("fx")
class HC_DOMImplementation_Feature_No_Version_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_domimplementationfeaturenoversion")
 void run() throws Throwable {
  ...
  assertTrue(state, "hasFeatureBlank");
 }
}