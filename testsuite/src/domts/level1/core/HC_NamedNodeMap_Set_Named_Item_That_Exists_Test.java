...
*/
@Disabled("fx")
class HC_NamedNodeMap_Set_Named_Item_That_Exists_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_namednodemapsetnameditemthatexists")
 void run() throws Throwable {
  ...
  assertEquals("", attrValue, "namednodemapSetNamedItemThatExistsAssert");
 }
}