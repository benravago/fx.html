...
*/
class HC_CharacterData_Replace_Data_Middle_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_characterdatareplacedatamiddle")
 void run() throws Throwable {
  ...
  assertEquals("1230 South Ave. Dallas, Texas 98551", childData, "characterdataReplaceDataMiddleAssert");
 }
}