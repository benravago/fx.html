...
*/
class HC_NamedNodeMap_Set_Named_Item_With_New_Value_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_namednodemapsetnameditemwithnewvalue")
 void run() throws Throwable {
  ...
  assertNull(newNode, "prevValueNull");
 }
}