...
*/
class HC_Element_Replace_Attribute_With_Self_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_elementreplaceattributewithself")
