...
*/
@Disabled("fx")
class HC_Node_Insert_Before_Ref_Child_NonExistent_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_nodeinsertbeforerefchildnonexistent")
