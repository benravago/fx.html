...
*/
class HC_Node_Clone_Node_False_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_nodeclonenodefalse")
 void run() throws Throwable {
  ...
  assertTrue(equalsAutoCase("element", "p", cloneName), "strong");
