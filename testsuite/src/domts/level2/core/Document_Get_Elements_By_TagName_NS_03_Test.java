...
*/
class Document_Get_Elements_By_TagName_NS_03_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/core/documentgetelementsbytagnameNS03")
 void run() throws Throwable {
  Document doc;
  NodeList childList;
  doc = (Document) load("staffNS", false);
  childList = doc.getElementsByTagNameNS("**", "*");
  assertTrue(equalsSize(0, childList), "documentgetelementsbytagnameNS03");
 }
}