...
*/
class HTML_Mod_Element_03_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLModElement03")
 void run() throws Throwable {
  ...
  assertTrue(equalsURI(null, null, null, "del-reasons.html", null, null, null, null, vcite), "citeLink");
 }
}