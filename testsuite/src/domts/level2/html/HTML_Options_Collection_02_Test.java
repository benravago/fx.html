...
*/
class HTML_Options_Collection_02_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLOptionsCollection02")
 void run() throws Throwable {
  ...
  assertEquals("EMP10004", vvalue, "valueIndexLink");
 }
}