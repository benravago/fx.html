...
*/
class HTML_Element_135_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement135")
 void run() throws Throwable {
  ...
  assertEquals("KBD-class", vclassname, "classNameLink");
 }
}