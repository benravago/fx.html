...
*/
class HTML_Element_131_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement131")
 void run() throws Throwable {
  ...
  assertEquals("STRONG-class", vclassname, "classNameLink");
 }
}