...
*/
class HTML_Element_38_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement38")
 void run() throws Throwable {
  ...
  assertEquals("U Element", vtitle, "titleLink");
 }
}