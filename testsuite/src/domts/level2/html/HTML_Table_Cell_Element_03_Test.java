...
*/
class HTML_Table_Cell_Element_03_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLTableCellElement03")
 void run() throws Throwable {
  ...
  assertEquals("hd1", vabbr, "abbrLink");
 }
}