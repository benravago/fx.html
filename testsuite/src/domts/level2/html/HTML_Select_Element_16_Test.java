...
*/
class HTML_Select_Element_16_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLSelectElement16")
 void run() throws Throwable {
  ...
  ((HTMLSelectElement) /*Node */testNode).remove(0);
  optLength = (int) ((HTMLSelectElement) /*Node */testNode).getLength();
  assertEquals(4, optLength, "optLength");
