...
*/
class HTML_Quote_Element_01_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLQuoteElement01")
 void run() throws Throwable {
  ...
  assertTrue(equalsURI(null, null, null, "Q.html", null, null, null, null, vcite), "citeLink");
 }
}