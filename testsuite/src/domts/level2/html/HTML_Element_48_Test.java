...
*/
class HTML_Element_48_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement48")
 void run() throws Throwable {
  ...
  assertEquals("KBD Element", vtitle, "titleLink");
 }
}