...
*/
class HTML_Table_Row_Element_12_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLTableRowElement12")
 void run() throws Throwable {
  ...
  newCell = ((HTMLTableRowElement) /*Node */testNode).insertCell(6);
  testNode = nodeList.item(3);
  cellsnodeList = ((HTMLTableRowElement) /*Node */testNode).getCells();
  vcells = (int) cellsnodeList.getLength();
