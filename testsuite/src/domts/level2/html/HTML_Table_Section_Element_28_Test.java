...
*/
class HTML_Table_Section_Element_28_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLTableSectionElement28")
 void run() throws Throwable {
  ...
  testNode = nodeList.item(0);
  {
   ...
   assertTrue(success, "HTMLTableSectionElement28");
  }
 }
}