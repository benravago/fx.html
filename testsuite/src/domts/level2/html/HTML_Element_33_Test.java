...
*/
class HTML_Element_33_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement33")
 void run() throws Throwable {
  ...
  assertEquals("SPAN Element", vtitle, "titleLink");
 }
}