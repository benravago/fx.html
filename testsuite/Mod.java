...
public class Mod {
    ...
    String parserSetting(String s) {
        switch (s) {
            case "namespaceAware": return "setNamespaceAware(true)";
            case "notNamespaceAware": return "setNamespaceAware(false)";
            case "validating": return "setValidating(true)";
            case "notValidating": return "setValidating(false)";
            case "notCoalescing": return "setCoalescing(false)";
            case "notExpandEntityReferences": return "setExpandEntityReferences(false)";
            case "signed": return "feature(\"signed\")";
            case "hasNullString": return "feature(\"hasNullString\")";
            default: return s;
        }
    }
    ...
    String equiv(String f) {
        switch (f) {
            case "Size": return "equalsSize";
            case "URIEquals": return "equalsURI";
            case "EqualsAutoCase": return "equalsAutoCase";
            case "EqualsIgnoreCase": return "equalsIgnoreCase";
