...
*/
class HC_Node_Value_04_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_nodevalue04")
 void run() throws Throwable {
  ...
  assertTrue(((newNode != null) | ("text/html".equals(getContentType()))), "docTypeNotNullOrDocIsHTML");
  if ((newNode != null)) {
