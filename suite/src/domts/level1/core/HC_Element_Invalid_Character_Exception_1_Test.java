...
*/
class HC_Element_Invalid_Character_Exception_1_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_elementinvalidcharacterexception1")
