...
*/
class HC_CharacterData_Delete_Data_Exceeds_Length_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_characterdatadeletedataexceedslength")
