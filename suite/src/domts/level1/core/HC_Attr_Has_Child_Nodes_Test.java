...
*/
class HC_Attr_Has_Child_Nodes_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_attrhaschildnodes")
 void run() throws Throwable {
  ...
  assertTrue(hasChildNodes, "hasChildrenIsTrue");
 }
}