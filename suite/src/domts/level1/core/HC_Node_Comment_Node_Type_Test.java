...
*/
class HC_Node_Comment_Node_Type_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_nodecommentnodetype")
 void run() throws Throwable {
  ...
  for (int indexN10040 = 0; indexN10040 < testList.getLength(); indexN10040++) {
   ...
   if (equals("#comment", commentNodeName)) {
    ...
    assertEquals(8, nodeType, "existingCommentNodeType");
   }
  }
  commentNode = doc.createComment("This is a comment");
  nodeType = (int) commentNode.getNodeType();
  assertEquals(8, nodeType, "createdCommentNodeType");
 }
}