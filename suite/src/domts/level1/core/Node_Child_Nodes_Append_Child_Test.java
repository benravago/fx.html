...
*/
class Node_Child_Nodes_Append_Child_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/nodechildnodesappendchild")
 void run() throws Throwable {
  ...
  assertEquals(expectedLength, length, "childNodeLength");
 }
}