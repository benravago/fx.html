...
*/
class Document_Create_DocumentFragment_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/documentcreatedocumentfragment")
 void run() throws Throwable {
  ...
  assertEquals("#document-fragment", newDocFragmentName, "name");
