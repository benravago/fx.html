...
*/
class HC_Node_Clone_False_No_Copy_Text_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_nodeclonefalsenocopytext")
 void run() throws Throwable {
  ...
  assertNull(lastChildNode, "nodeCloneFalseNoCopyTextAssert1");
 }
}