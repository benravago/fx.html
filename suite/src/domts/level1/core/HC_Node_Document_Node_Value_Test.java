...
*/
class HC_Node_Document_Node_Value_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_nodedocumentnodevalue")
 void run() throws Throwable {
  Document doc;
  String documentValue;
  doc = (Document) load("hc_staff", false);
  documentValue = doc.getNodeValue();
  assertNull(documentValue, "documentNodeValue");
 }
}