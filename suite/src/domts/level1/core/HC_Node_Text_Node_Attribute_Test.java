...
*/
class HC_Node_Text_Node_Attribute_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_nodetextnodeattribute")
 void run() throws Throwable {
  ...
  assertNull(attrList, "text_attributes_is_null");
 }
}