...
*/
@Disabled("1")
class HC_NamedNodeMap_Return_First_Item_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_namednodemapreturnfirstitem")
