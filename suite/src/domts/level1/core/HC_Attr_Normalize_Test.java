...
*/
@Disabled("fx")
class HC_Attr_Normalize_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_attrnormalize")
 void run() throws Throwable {
  ...
  assertEquals("Yesterday", value, "firstChildValue");
  secondChild = firstChild.getNextSibling();
  assertNull(secondChild, "secondChildIsNull");
 }
}