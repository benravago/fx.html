...
*/
class HC_CharacterData_Index_Size_Err_Substring_Negative_Offset_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
  feature("signed");
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/hc_characterdataindexsizeerrsubstringnegativeoffset")
