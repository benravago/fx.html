...
*/
@Disabled("fx")
class NamedNodeMap_Set_Named_Item_Return_Value_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level1/core/namednodemapsetnameditemreturnvalue")
 void run() throws Throwable {
  ...
  assertEquals("No", attrValue, "returnedNodeValue");
 }
}