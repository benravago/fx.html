...
*/
class NamedNode_Map_Set_NamedItem_NS_08_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/core/namednodemapsetnameditemns08")
 void run() throws Throwable {
  ...
  attributes = element.getAttributes();
  {
   ...
   assertTrue(success, "namednodemapsetnameditemns08");
  }
 }
}