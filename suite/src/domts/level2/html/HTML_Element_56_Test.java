...
*/
class HTML_Element_56_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement56")
 void run() throws Throwable {
  ...
  assertEquals("NOSCRIPT Element", vtitle, "titleLink");
 }
}