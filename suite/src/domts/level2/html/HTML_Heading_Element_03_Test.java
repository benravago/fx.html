...
*/
class HTML_Heading_Element_03_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLHeadingElement03")
 void run() throws Throwable {
  ...
  assertEquals("right", valign, "alignLink");
 }
}