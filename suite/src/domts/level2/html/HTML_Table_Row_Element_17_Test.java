...
*/
class HTML_Table_Row_Element_17_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLTableRowElement17")
 void run() throws Throwable {
  ...
  testNode = nodeList.item(3);
  {
   ...
   try {
    ((HTMLTableRowElement) /*Node */testNode).deleteCell(7);
   } catch (DOMException ex) {
    success = (ex.code == DOMException.INDEX_SIZE_ERR);
   }
   assertTrue(success, "HTMLTableRowElement17");
  }
 }
}