...
*/
class HTML_Select_Element_06_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLSelectElement06")
 void run() throws Throwable {
  ...
  fNode = ((HTMLSelectElement) /*Node */testNode).getForm();
  vform = fNode.getId();
