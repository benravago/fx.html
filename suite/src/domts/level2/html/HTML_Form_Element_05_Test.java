...
*/
class HTML_Form_Element_05_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLFormElement05")
 void run() throws Throwable {
  ...
  vaction = ((HTMLFormElement) /*Node */testNode).getAction();
  assertTrue(equalsURI(null, null, null, "getData.pl", null, null, null, null, vaction), "actionLink");
 }
}