...
*/
class HTML_Options_Collection_05_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLOptionsCollection05")
 void run() throws Throwable {
  ...
  optionsNode = ((HTMLCollection) /*HTMLCollection */formsnodeList).namedItem("select9");
  assertNull(optionsNode, "nameIndexLink");
 }
}