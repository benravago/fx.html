...
*/
class HTML_Element_22_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement22")
 void run() throws Throwable {
  ...
  assertEquals("Test-ACRONYM", vid, "idLink");
 }
}