...
*/
class HTML_Element_117_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLElement117")
 void run() throws Throwable {
  ...
  assertEquals("HEAD-class", vclassname, "classNameLink");
 }
}