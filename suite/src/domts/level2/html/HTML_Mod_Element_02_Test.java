...
*/
class HTML_Mod_Element_02_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLModElement02")
 void run() throws Throwable {
  ...
  assertEquals("January 1, 2002", vdatetime, "dateTimeLink");
 }
}