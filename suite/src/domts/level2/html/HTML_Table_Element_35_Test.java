...
*/
class HTML_Table_Element_35_Test extends domts.DOMTestCase {
 @BeforeEach
 void setup() {
 ...
 @Test
 @DisplayName("http://www.w3.org/2001/DOM_Test_Suite/level2/html/HTMLTableElement35")
 void run() throws Throwable {
  ...
  testNode = nodeList.item(1);
  {
   ...
   assertTrue(success, "HTMLTableElement35");
  }
 }
}